            ...
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form method="POST" action="{{ route('food.checkout.store') }}" class="col-md-12">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="country" name="country" class="form-control" id="email" placeholder="Country">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="phone_number" id="email" placeholder="Phone number">
